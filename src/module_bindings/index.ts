...
import PhotoGroupRow from "./photo_group_table";
import PhotoGroupMemberRow from "./photo_group_member_table";
...
const tablesSchema = __schema({
  ...
  guest: __table({
    ...
    indexes: [
      ...
      { accessor: 'byName', name: 'guest_name_idx_btree', algorithm: 'btree', columns: [
        'name',
      ] },
    ],
    constraints: [
  ...
  photoGroup: __table({
    name: 'photo_group',
    indexes: [
      { accessor: 'id', name: 'photo_group_id_idx_btree', algorithm: 'btree', columns: [
        'id',
      ] },
    ],
    constraints: [
      { name: 'photo_group_id_key', constraint: 'unique', columns: ['id'] },
    ],
  }, PhotoGroupRow),
  photoGroupMember: __table({
    name: 'photo_group_member',
    indexes: [
      { accessor: 'byGroupId', name: 'photo_group_member_group_id_idx_btree', algorithm: 'btree', columns: [
        'groupId',
      ] },
      { accessor: 'id', name: 'photo_group_member_id_idx_btree', algorithm: 'btree', columns: [
        'id',
      ] },
    ],
    constraints: [
      { name: 'photo_group_member_id_key', constraint: 'unique', columns: ['id'] },
    ],
  }, PhotoGroupMemberRow),
...
const reducersSchema = __reducers(
  ...
  __reducerSchema("add_guest_to_photo_group", AddGuestToPhotoGroupReducer),
  __reducerSchema("add_photo_group", AddPhotoGroupReducer),
  ...
  __reducerSchema("delete_photo_group", DeletePhotoGroupReducer),
  ...
  __reducerSchema("remove_guest_from_photo_group", RemoveGuestFromPhotoGroupReducer),
  __reducerSchema("rename_guest", RenameGuestReducer),
  __reducerSchema("rename_photo_group", RenamePhotoGroupReducer),
